...
CATALOG: list[dict] = [
    ...
    _e("manager.audit.automated_actors", "list", "Automated users", "Usernames whose actions count as automated (smoke tests, bots). One per line.", "audit", MANAGER, hot=True),
